...
master | 3.3.5 | Legion | master | master | master | master 
:------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------:
...
It is derived from *[MaNGOS](https://github.com/mangos)*, *[TrinityCore](https://github.com/TrinityCore)*, the *Massive Network Game Object Server*, and is
